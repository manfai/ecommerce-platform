...
<body class="bg-base-100">
    ...
    <div class="relative flex items-center justify-between">
        ...
        <ul class="flex items-center hidden space-x-8 lg:flex">
            <li><a href="/product" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Product</a></li>
            <li><a href="/" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Your Cart</a></li>
