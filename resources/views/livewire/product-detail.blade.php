  ...
  <div class="lg:w-1/2 w-full lg:pl-10 lg:pb-6 mt-6 lg:mt-0">
    ...
    <div class="flex mb-4">
      <span class="flex items-center">
        <svg class="w-5 h-5 text-primary fill-current stroke-current" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M23.9986 5L17.8856 17.4776L4 19.4911L14.0589 29.3251L11.6544 43L23.9986 36.4192L36.3454 43L33.9586 29.3251L44 19.4911L30.1913 17.4776L23.9986 5Z" fill="" stroke="" stroke-width="4" stroke-linejoin="round" />
        </svg>
        <svg class="w-5 h-5 text-primary fill-current stroke-current" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M23.9986 5L17.8856 17.4776L4 19.4911L14.0589 29.3251L11.6544 43L23.9986 36.4192L36.3454 43L33.9586 29.3251L44 19.4911L30.1913 17.4776L23.9986 5Z" fill="" stroke="" stroke-width="4" stroke-linejoin="round" />
        </svg>
        ...
        <svg class="w-5 h-5 text-primary fill-current stroke-current" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          <path d="M23.9986 5L17.8856 17.4776L4 19.4911L14.0589 29.3251L11.6544 43L23.9986 36.4192L36.3454 43L33.9586 29.3251L44 19.4911L30.1913 17.4776L23.9986 5Z" fill="none" stroke="" stroke-width="4" stroke-linejoin="round" />
        </svg>
    ...
    <div class="flex">
      ...
      <form class="ml-auto" action="{{route('cart.add')}}" method="post">
        ...
        <button type="submit" class="flex ml-auto inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none">Add To Cart</button>
      </form>
      ...
      <button wire:click="favor()" class="rounded bg-gray-200 px-4 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
        <svg class="w-5 h-5 fill-current stroke-current" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15 8C8.92487 8 4 12.9249 4 19C4 30 17 40 24 42.3262C31 40 44 30 44 19C44 12.9249 39.0751 8 33 8C29.2797 8 25.9907 9.8469 24 12.6738C22.0093 9.8469 18.7203 8 15 8Z" fill="none" stroke="" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </button>
      @else
      <button wire:click="disfavor()" class="rounded bg-gray-200 px-4 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
        <svg class="w-5 h-5 fill-current stroke-current" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M44 19C44 12.9249 39.0751 8 33 8C29.2797 8 25.9907 9.8469 24 12.6738C22.0093 9.8469 18.7203 8 15 8C8.92487 8 4 12.9249 4 19C4 30 17 40 24 42.3262C25.1936 41.9295 26.5616 41.3098 28.0099 40.5" stroke="" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M34.9589 27L41.8373 35.5" stroke="" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M41.8373 27L34.9589 35.5" stroke="" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </button>
      @endif
